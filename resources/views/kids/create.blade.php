...
@section('content')
    ...
    <div class="section-header">
        <div>
            <div class="page-title">Tambah Data Anak</div>
            <div class="page-subtitle">
                Tambahkan data anak, lokasi rumah, dan titik antar jemput
            </div>
        </div>
    </div>
        ...
        <form method="POST" action="{{ route('kids.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="school_name" class="form-control @error('school_name') is-invalid @enderror"
                    value="{{ old('school_name') }}" placeholder="Masukkan nama sekolah" required>
