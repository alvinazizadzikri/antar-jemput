...
@section('content')
    ...
    <div class="form-card">
        ...
        <form method="POST" action="{{ route('kids.update', $kid->id) }}" enctype="multipart/form-data">
            ...
            <input type="hidden" name="latitude" id="latitude" value="{{ $kid->latitude }}">

            <input type="hidden" name="longitude" id="longitude" value="{{ $kid->longitude }}">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            let defaultLat = {{ $kid->latitude ?? -8.2308 }};
            let defaultLng = {{ $kid->longitude ?? 111.3227 }};
